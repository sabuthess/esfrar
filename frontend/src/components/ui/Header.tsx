				...
				<div>
					...
					<nav
						...
						<div className='flex flex-col lg:flex lg:flex-row justify-center items-center gap-3 text-center'>
							<Link href={`/login`}>
								<button className='py-2 px-5 hover:outline hover:outline-gray-500 transition-all '>
									Sing in
								</button>
							</Link>
							<Link href={`/register`}>
								<button className='py-1.5 px-5 hover:outline hover:outline-gray-500 transition-all '>
									Register
								</button>
							</Link>
							<Link
