		...
		<>
			<div className='relative z-10 w-full max-w-md p-8  bg-none'>
				...
				<div className='flex flex-col gap-4'>
					...
					<button className='w-full p-4 border border-white/20  hover:bg-[#16a084]/20 text-white font-medium rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl'>
						Sign In
					</button>
				</div>
				...
				<div className='text-center mt-6'>
					<p className='text-gray-400 text-sm flex justify-center gap-1 '>
						...
						<button className='text-[#16a084] hover:underline'>
							Create one
						</button>
					</p>
				</div>
